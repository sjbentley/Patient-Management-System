    ...
    try {
      if (type === "create" && patientId) {
        ...
        const appointmentToUpdate = {
          ...
          type,
          timeZone, // Add this here after properly declaring it
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 space-y-6">
          ...
          <>
            ...
            >
              ...
              <CustomFormField
                ...
                placeholder="Nachmittage bevorzugt"
                disabled={type === "schedule"}
              />
            </div>
          </>
        ...
        {type === "cancel" && (
          <CustomFormField
            ...
            placeholder="Dringendes Meeting steht an"
          />
        )}
